...
{
move_uploaded_file($_FILES["bookpic"]["tmp_name"],"C:/wamp64/www/php/admin/bookimg/".$imgnewname);
$sql="INSERT INTO  tblbooks(BookName,Copies,CatId,AuthorId,ISBNNumber,BookPrice,bookImage) VALUES(:bookname,:copies,:category,:author,:isbn,:price,:imgnewname)";
...
<?php 
$CurrentStatus=1;
$sql = "SELECT * from  tblcategory where CurrentStatus=:CurrentStatus";
$query = $dbh -> prepare($sql);
